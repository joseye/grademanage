...
public class EncryptionUtil {
	...
	public static void main(String[] args) {
		try {
			Map<String, Object>m=EncryptionUtil.initKey();
...
//			os.close();
	...
	public static void test1(String publicKey, String privateKey) throws Exception {  
        System.err.println("公钥加密——私钥解密");  
        String inputStr = "我是中国人";  
...
//        String outputStr = new String(decodedData);  
        System.out.println("加密后"+encryptBASE64(encodedData));
